        ...
        .then(
            function(logResults){
                ...
                if (cli.program.jirakey){
                    issueKey = cli.program.jirakey;
                }else{
                    issueKey = buildResults[0].commitObj.branch;

                    issueKey = issueKey.substr(issueKey.lastIndexOf('/')+1); //strip everything before the last /, it should be the jira key
                }
